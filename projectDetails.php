            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="project-thumb d-flex align-self-stretch">
                        <img src="assets/images/bg/project-details-bg-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-xl-4">
                    ...
                    <div class="details-content details-content__project">
                        ...
                        <div class="row mt-10">
                            <div class="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                <div class="project-item">
                                    <div class="project-item__thumb project-item__thumb--big">
                                        <img src="assets/images/project/p-13.jpg" alt="">
                                    </div>
                                    <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                        <a href="project-details.php" class="project-item__link">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                <div class="project-item">
                                    <div class="project-item__thumb project-item__thumb--big">
                                        <img src="assets/images/project/p-14.jpg" alt="">
                                    </div>
                                    <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                <div class="project-item">
                                    <div class="project-item__thumb project-item__thumb--big">
                                        <img src="assets/images/project/p-15.jpg" alt="">
                                    </div>
                                    <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                        <a href="project-details.php" class="project-item__link">
                                            <i class="far fa-arrow-right"></i>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 d-flex mt-30">
                                <div class="project-item">
                                    <div class="project-item__thumb project-item__thumb--big">
                                        <img src="assets/images/project/p-16.jpg" alt="">
                                    </div>
                                    <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                        <a href="project-details.php" class="project-item__link">
                                            <i class="far fa-arrow-right"></i>
