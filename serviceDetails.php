                ...
                <div class="col-xl-4">
                    <div class="sidebar grey-bg">
                        ...
                        <ul class="sidebar__list">
                            <li>
                                <a href="service-details.php">Banner Printing <span class="icon">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li>
                                <a href="service-details.php">Billboard Printing <span class="icon">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li>
                                <a href="service-details.php">Business Card <span class="icon">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li>
                                <a href="service-details.php">Poster Printing <span class="icon">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="service-details.php">T-Shirt Printing <span class="icon">
                                        <span class="icon"><i class="far fa-arrow-right"></i></span>
                                </a>
                            </li>
                        </ul>
