                                ...
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><a href="#0">Branding and Printing</a>
                                            <ul class="sub-menu">
                                                <li><a href="service-details.php"></a></li>
                                                <li><a href="service-details.php">Banners and Printing</a></li>
                                                <li><a href="project-details.php">Gifts and Clothing</a></li>
                                                <li><a href="project-details.php">Signature</a></li>
                            ...
                            <div class="project-item">
                                ...
                                <div class="project-item__hover" data-overlay="dark" data-opacity="9">
                                    ...
                                    <div class="project-item__content">
                                        ...
                                        <h4 class="project-item__title">Magazine Cover</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
